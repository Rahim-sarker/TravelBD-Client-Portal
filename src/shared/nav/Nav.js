        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="flex-1 flex items-center justify-center lg:items-stretch lg:justify-start">
            <div className="flex-shrink-0 flex items-center">
              <Link to="/">
                <h1 className="text-2xl text-decoration-none   text-white">Travel.BD </h1>
              </Link>
            </div>
            <div className="hidden lg:block lg:ml-6">
              <div className="flex space-x-4">
                <NavLink
                  exact
                  to="/"
                  className=" text-decoration-none text-white px-3 py-2 rounded-md text-sm font-medium"
                ...
                <NavLink
                  to="/admin"
                  className="text-decoration-none bg-green-500 text-white px-3 py-2 rounded-md text-sm font-medium"
              ...
              <div>
                {user ? (
                  ...
                  <button
                    ...
                    aria-haspopup="true"
                  >
                    <span className="text-white ms-2 mr-2 text-xl hidden sm:block">
                      {user?.displayName}
                    </span>
                    <img
